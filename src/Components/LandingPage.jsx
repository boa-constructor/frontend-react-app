...
const LandingPage = () => {
	...
	const clickHandler = () => {
		currentUser ? navigate('/users') : navigate('/login');
	};
	return (
		<div>
			<div
			...
			>
				<div className='px-8 py-16'>
					<div className='grid grid-cols-1 gap-7  max-w-[600px]'>
						...
						<button
							className='bg-gradient-to-r from-pink-600 w-70 bg-red-500 p-2 px-3 text-lg  hover:bg-red-600 duration-300 hover:scale-110 rounded-md'
							onClick={clickHandler}
						>
							{currentUser ? 'Find Users' : 'Login / Sign Up'}
						</button>
					</div>
				</div>
			</div>
